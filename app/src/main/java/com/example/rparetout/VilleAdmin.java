...
public class VilleAdmin extends AppCompatActivity {
    ListView listView;
    String[] liste = {"ajoute une ville" , "affiche les villes"};
    Button flesh ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ville_admin);
        flesh = findViewById(R.id.flesh);
        flesh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VilleAdmin.this,Access.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    Intent intent = new Intent(VilleAdmin.this,InVille.class);
                    startActivity(intent);
                }
                if (position == 1) {
                    Intent intent = new Intent(VilleAdmin.this,AfficheVille.class);
                    startActivity(intent);
