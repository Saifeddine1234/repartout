...
public class DemandeAccepterAdmin extends AppCompatActivity implements ImageAdapterAccepte.OnItemClickListener{
    private RecyclerView mRecyclerView;
    private ImageAdapterAccepte mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapterAccepte(DemandeAccepterAdmin.this, mUploads);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(DemandeAccepterAdmin.this);
        ...
        mBDListener =   mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    if (postSnapshot.child("t11").getValue().equals("Acceptée")) {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DemandeAccepterAdmin.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
