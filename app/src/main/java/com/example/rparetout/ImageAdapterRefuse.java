...
public class ImageAdapterRefuse extends RecyclerView.Adapter<ImageAdapterRefuse.ImageViewHolderclient> {
    private Context mContext;
    private List<DemandeClass> mUploads ;
    //FragmentActivity mListener;
    DatabaseReference databaseReference ;
    ImageAdapterRefuse.OnItemClickListener mListener;

    public ImageAdapterRefuse(Context context , List<DemandeClass> uploads){
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    ...
    public void onBindViewHolder(@NonNull final ImageViewHolderclient holder, final int position) {
        ...
        if (uploadCor.getT11().equals("Refusée")){
            ...
            holder.txt10.setTextColor(0xD5FF0000);
    ...
    public void setOnItemClickListener(DemandeRefuserAdmin listener){
        mListener = listener;
    }
}
