...
public class MessageAdapterAdmin extends RecyclerView.Adapter<MessageAdapterAdmin.ImageViewHolderclient> {
    ...
    public MessageAdapterAdmin(Context context , List<Chat> uploads){
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    ...
    public void onBindViewHolder(@NonNull final ImageViewHolderclient holder, final int position) {
        ...
        if (uploadCor.getType().equals("text")){
            ...
            holder.txt11.setText(uploadCor.getSender());
