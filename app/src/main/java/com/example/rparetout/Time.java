...
public class Time   extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
TextView textT , textD ,t1,t2;
SeekBar seekBar,seekBar2;
String txt1,txt2,txt3  ,time1,time2;
Button B1 , B2 ,dacc;
    @Override
        ...
        dacc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (textD.getText().toString().equals("")) {
                    Toast.makeText(Time.this, "select un Date", Toast.LENGTH_SHORT).show();
                } else if (t2.getText().toString().equals("00") || t1.getText().toString().equals("00")) {
                    Toast.makeText(Time.this, "Select l'interval de temps", Toast.LENGTH_SHORT).show();
                } else if (Integer.parseInt(txt3) < Integer.parseInt(txt2)) {
                    Toast.makeText(Time.this, "l'interval est incorrect", Toast.LENGTH_SHORT).show();

                } else {
                    time1 = textD.getText().toString() + " " + t2.getText().toString() + "H" + " - " + t1.getText().toString() + "H";
